...
export class VendedorUsuarioVendedorController {
  ...
  async get(
    ...
    return this.vendedorRepository.tiene_usuario(id).get(filter);
  }
  ...
  async create(
    ...
    return this.vendedorRepository.tiene_usuario(id).create(usuarioVendedor);
  }
  ...
  async patch(
    ...
    return this.vendedorRepository.tiene_usuario(id).patch(usuarioVendedor, where);
  }
  ...
  async delete(
    ...
    return this.vendedorRepository.tiene_usuario(id).delete(where);
  }
}
